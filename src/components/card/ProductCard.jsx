  ...
  return (
    ...
    <div className='border rounded-md shadow-md p-2 w-48'>
      <div>
        {
          ...
          ? <img src={item.images[0].url} className='rounded-md w-full h-24 object-cover hover:scale-110 hover:duration-200' alt="" />
      ...
      <div className='py-2'>
        ...
        <p className='text-sm truncate text-gray-500'>{item.description}</p>
      </div>
