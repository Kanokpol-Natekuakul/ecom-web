...
import { ChartBarStacked, CircleGauge, FolderKanban, ListOrdered, LogOut, ShoppingBasket } from 'lucide-react';
  ...
  return (
    <div className='bg-gray-800 w-64 text-gray-100 flex flex-col h-screen'>
      ...
      <nav className='flex-1 px-4 py-4 space-y-2'>
        ...
        isActive ? 'bg-gray-900 rounded-md text-white px-4 py-2 flex items-center' : 'text-gray-400 px-4 py-2 hover:bg-gray-700 hover:text-white rounded flex items-center '}>
